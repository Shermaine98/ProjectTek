 ...
 */
public class Excel_KinderPublic {
     ...
     */
    public Excel_KinderPublic(final InputStream in) throws IOException {
    ...
    public Excel_KinderPublic(final HSSFWorkbook book) throws IOException {
        sdf = new SimpleDateFormat("dd/MM/yyyy");
        this.book = book;
        palette = book.getCustomPalette();
        evaluator = book.getCreationHelper().createFormulaEvaluator();
