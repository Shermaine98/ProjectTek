...
import Excel.Excel_HighestAttainment;
...
public class UploadHighestAttainment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
            ...
            if(sheetNumber>-1){
                String table = new Excel_HighestAttainment(wb, sheetNumber).getHTML();
                session.setAttribute("table", table);
                System.out.print(table);
                ServletContext context= getServletContext();
                RequestDispatcher rd= context.getRequestDispatcher("/WEB-INF/JSPDemo/previewHighestAttainment.jsp");
