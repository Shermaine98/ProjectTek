...
<html>
    <head>
        ...
        <title>Reports Library | Government Secondary Schools - Teacher Deployment</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <ol class="breadcrumb" style='background: transparent; margin-left: 3%; font-size: 120%;'>
                    ...
                    <li class="active title">Government Secondary Schools - Teacher Deployment</li>
                </ol>
                <!-- Main content -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-success" style="padding-bottom: 5%;">
                                ...
                                <div class="box-body">
                                    <form action="UploadGovSecondaryTeacherDeployment" method="post" enctype="multipart/form-data">
