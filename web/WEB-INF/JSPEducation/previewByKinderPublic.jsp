<%-- 
    Document   : previewByKinderPublic
    Created on : Jun 15, 2016, 11:16:56 PM
                ...
                <section class="content-header">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <center><h1 class="box-title"><b>Preview of Kindergarten Data in Public Elementary School</b></h1></center>
                            <br>
                            <% String table = null;
