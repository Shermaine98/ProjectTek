...
<html>
    <head>
        ...
        <title>Reports Library | Mortality Report</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <ol class="breadcrumb" style='background: transparent; margin-left: 3%; font-size: 120%;'>
                    ...
                    <li class="active title">Mortality Report</li>
                </ol>
                <!-- Main content -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-success" style="padding-bottom: 5%;">
                                ...
                                <div class="box-body">
                                    <form action="UploadMortalityReport" method="post" enctype="multipart/form-data">
